...
<block v-if="item==''">
    ...
    <view class="weui-footer_fixed-bottom">
        <view class="padding flex flex-direction">
			...
			<button @tap="fh" class="cu-btn bg-red margin-tb-sm lg" :data-avatar="item.avatar" :data-card="item.card">返回</button>
        </view>
    </view>
</block>
<block v-else>
    ...
    <view class="weui-footer_fixed-bottom">
        <view class="padding flex flex-direction">
            ...
            <button @tap="saveImg" class="cu-btn bg-pink margin-tb-sm lg" :data-avatar="item.avatar" :data-card="item.card">下载套图</button>
			<button @tap="fh" class="cu-btn bg-red margin-tb-sm lg" :data-avatar="item.avatar" :data-card="item.card">返回</button>
        </view>
    </view>
</block>
