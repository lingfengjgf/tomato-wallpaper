		...
		<view class="" v-show="!loadShow">
			...
			<view class="tags u-p-l-40 u-p-t-40 u-p-r-30">
				...
				<view class="u-flex u-row-left u-flex-wrap u-p-t-30">
					<view class="tag" @click="listClick('tags','',item.name)" v-for="(item, index) in zodiacList" :key="index">{{item.name}}</view>
				</view>
			</view>
			<view class="category u-p-l-30 u-p-t-40 u-p-r-30">
				<view class="u-font-18 u-p-l-10">壁纸分类</view>
				<view class="u-flex u-row-left u-flex-wrap u-p-t-30">
					<view class="cate" @click="listClick('category',index,item._id)" v-if="item.image" v-for="(item, index) in categoryList" :key="index">
